        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" overflow-hidden">
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    <input type="text" name="name" class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-200 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                    ...
                    <div class="relative z-0">
                    <input type="text" name="email" class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-200 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                    ...
                    <textarea name="message" rows="5" class="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-200 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" "></textarea>
